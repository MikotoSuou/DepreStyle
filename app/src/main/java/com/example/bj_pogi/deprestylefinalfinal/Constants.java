...
public class Constants {
    ...
    //DOCTORS
    public static final String DR_AGUINALDO = "Emilio Aguinaldo";
    public static final String DR_BONIFACIO = "Andres Bonifacio";
    public static final String DR_MABINI = "Apolinario Mabini";
    ...
    public static final String PLS_VERIFY_EMAIL_ADD = "Please verify email address";
